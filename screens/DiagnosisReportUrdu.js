...
const DiagnosisReportUrdu = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>رپورٹ کی تشخیص</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.resultCard}>
            <Text style={styles.errorText}>اوہ!</Text>
            <Text style={styles.resultDescription}>آپ کا پودا خراب ہے۔</Text>
            {image ? (
              <View style={styles.imageContainer}>
                <Image source={{ uri: image }} style={styles.image} resizeMode="contain" />
                <TouchableOpacity style={styles.changeImageButton} onPress={changeImage}>
                  <Text style={styles.changeImageText}>تصویر تبدیل کریں</Text>
                </TouchableOpacity>
              </View>
            ) : (
              <TouchableOpacity style={styles.placeholderContainer} onPress={pickImage}>
                <Icon name="image-outline" size={50} color="#ccc" />
                <Text style={styles.placeholderText}>تصویر منتخب کریں</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.diseaseCard}>
            <Text style={styles.diseaseText}>بیماری کی تفصیل یہاں شامل کریں۔</Text>
          </View>
        </View>
      </View>
    </View>
...
export default DiagnosisReportUrdu;
